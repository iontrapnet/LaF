...
function gfx.ImageSurface(x,y)
 ...
 if type(x) == 'string' then
     w.lcairo_object=graphics.newimage(x)
     w:setg('width',w.lcairo_object.width)
     w:setg('height',w.lcairo_object.height)
 else
     -- check parameters --..
     w:setg('width',x or w.globalDefaults['width']);
     w:setg('height',y or w.globalDefaults['height']);
     w:setg('startX',w.globalDefaults['startX']);
     w:setg('startY',w.globalDefaults['startY']);
